...
// CAMBIO: Importamos Pool desde 'pg' en lugar de Neon
...
/**
 * Nota: Aunque el nombre se mantiene como NeonAdapter por compatibilidad con el resto 
 * de tu código, ahora utiliza el Pool de 'pg' para Postgres tradicional.
 */
export default function NeonAdapter(client: Pool): NeonAdapter {
    return {
      ...
      RETURNING identifier, expires, token `;
        ...
        async getUserByEmail(email) {
            ...
            const accountsData = await client.query(
                'select * from auth_accounts where "userId" = $1', // Corregido: usualmente es userId el que vincula
                [userData.id]
            );
            return {
                ...userData,
      ...
      RETURNING id, "sessionToken", "userId", expires`;
        ...
        RETURNING *`; // Añadido RETURNING para obtener el resultado
            const result = await client.query(sql, [
